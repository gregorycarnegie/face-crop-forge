...
async function loadHaarCascades() {
    try {
        ...
        // Load alternative frontal face cascade for better detection
        try {
            await loadCascadeFromURL(
            ...
            // We'll use this as a fallback or for multi-scale detection
            console.log('✅ Alternative frontal face cascade available');
        } catch (altError) {
            console.log('⚠️ Alternative cascade not available:', altError.message);
        }
