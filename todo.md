...
- [x] Add component-level tests for the Leptos UI layer - 25 WASM tests across 6 components in `src/components/tests.rs`
- [x] Add browser-level end-to-end coverage for single-image detect -> crop -> export in `src/e2e_tests.rs`
